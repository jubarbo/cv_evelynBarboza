  ...
  return (
    <>
      ...
      <div className='contenedorCard'> 
        <Card titulo='Formación Académica' textCard='orem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 15er many web sites still in t'></Card>
      </div>
      <div className='contenedorCard'>
        <Card titulo='Experiencias Laborales' textCard='model text, and a search for lorem ipsum will uncover many web sites still in t'></Card>
      </div>
      </div>
      <div className='cards-container'>
      <div className='contenedorCard'> 
        <Card titulo='Proyectos Personales' textCard=''></Card>
      </div>
      <div className='contenedorCard'>
        <Card titulo='Experiencias Laborales' textCard='model text, and a search for lorem ipsum will uncover many web sites still in t'></Card>
      </div>
      ...
      <div className='contenedorCardPresentacion'>
        <CardPresentacion tituloP='Contacto' textCardP='Loggo whatsap, Logo Linkedin, gmail, y ta'></CardPresentacion>
      </div>
